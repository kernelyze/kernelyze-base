...
!             the code of integral_nsect_svar on which
!             it is based)
!
...
module integral_neigen_svar_mod
...
#define integral_rankn integral_neigen_svar
...
#include "template_integralrankn.f90"
  ...
  pure function get_effective_eval_pts(this) result(curr_eff_eval_pts)
    ! Arguments
    class(integral_neigen_svar), intent(in) :: this
    ! Result
...
end module integral_neigen_svar_mod